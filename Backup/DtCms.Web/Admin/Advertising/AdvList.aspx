...
<form id="form1" runat="server">
    <div class="navigation"><span class="add"><a href="AdvAdd.aspx">增加首页图片</a></span><b>您当前的位置：管理中心 &gt; 系统管理 &gt; 首页图片列表</b></div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      ...
      <tr>
        ...
        <td><a title="管理首页图片列表" href="BarList.aspx?Pid=<%#Eval("ID") %>"><%#Eval("Title")%></a></td>
        <td align="center">
        ...
        <div style="line-height:30px;height:30px;">
            ...
            <div class="left">
                ...
                <span class="btn_bg">
                    ...
                    OnClientClick="return confirm( '此操作将会删除首页图片，确定要删除吗？ ');" 
