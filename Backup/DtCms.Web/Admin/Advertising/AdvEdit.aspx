...
<form id="form1" runat="server">
    <div class="navigation">
      <span class="back"><a href="AdvList.aspx">返回列表</a></span><b>您当前的位置：管理中心 &gt; 系统管理 &gt; 编辑首页图片</b>
    </div>
      ...
      <tr>
        ...
        <td width="75%">
          <asp:TextBox ID="txtTitle" runat="server" CssClass="input required" size="30" 
            maxlength="50" HintTitle="首页图片名称" HintInfo="请填写首页图片名称，至少1个字符，小于50个字符，如“首页顶部首页图片”。"></asp:TextBox>
        </td>
       </tr>
       <tr>
       ...
       <tr style="display:none;">
         ...
         <td>
          <asp:TextBox ID="txtAdPrice" runat="server" CssClass="input required number" size="5" 
            maxlength="10" HintTitle="" HintInfo=""></asp:TextBox></td>
       </tr>
       <tr>
