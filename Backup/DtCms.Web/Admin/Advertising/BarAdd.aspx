...
<form id="form1" runat="server">
    <div class="navigation">
      <span class="back"><a href="BarList.aspx?Pid=<%=pid %>">返回列表</a></span><b>您当前的位置：管理中心 &gt; 系统管理 &gt; 增加首页图片内容</b>
    </div>
    <div class="spClear"></div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        <th colspan="2" align="left">发布首页图片</th>
      </tr>
      <tr>
        <td width="25%" align="right">所属首页图片：</td>
        <td width="75%">
            <asp:Label ID="lblAdTitle" runat="server" Font-Bold="True"></asp:Label>
            </td>
       </tr>
       <tr>
         <td align="right">首页图片名称：</td>
         <td>
          <asp:TextBox ID="txtTitle" runat="server" CssClass="input w250 required" size="30" 
            maxlength="50" HintTitle="首页图片标题名称" HintInfo="请填写首页图片名称以方便标识，如果是文字首页图片，将直接显示该文字，不能大于50个字符。"></asp:TextBox>
           </td>
        </tr>
       <tr>
        ...
        <tr style="display:none;">
         ...
         <td> 
          <asp:TextBox ID="txtLinkUrl" runat="server" CssClass="input w250 url" 
            maxlength="250" HintTitle="首页图片链接的网址" 
                 HintInfo="请填写首页图片要链接的网站，选填项，只对文字、图片首页图片有效，请以“http://”为开头，URL地址长度不可大于250位字符。"></asp:TextBox>
           </td>
       </tr>
       <tr>
         ...
         <td> 
          <asp:TextBox ID="txtAdRemark" runat="server" CssClass="textarea" style="width:300px;height:80px;" 
            HintTitle="备注(代码)" HintInfo="选填项，如果该首页图片类别是代码，请务必将内容填写在这里，如果该首页图片类别是文字、图片、幻灯片、动画、视频，该项可以为空。" TextMode="MultiLine"></asp:TextBox>
           </td>
       </tr>
       <tr>
          <td align="right">优先级别：</td>
          <td>
            <asp:TextBox ID="txtSortId" runat="server" CssClass="input required number" size="10" maxlength="10" HintTitle="首页图片内容的优先级别" HintInfo="纯数字，数值越小越靠前。">0</asp:TextBox>
          </td>
        </tr>
       <tr>
