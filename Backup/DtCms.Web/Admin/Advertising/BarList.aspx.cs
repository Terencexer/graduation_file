...
namespace DtCms.Web.Admin.Advertising
{
    public partial class BarList : DtCms.Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                JscriptMsg(350, 230, "错误提示", "<b>出现错误啦！</b>您要查看的首页图片不存在或者已经被删除了。", "back", "Error");
                return;
            }
            ...
            if (!Page.IsPostBack)
            {
                ...
                RptBind("Id>0" + CombAdSqlTxt(this.pid, this.keywords));
            }
        }
        ...
        protected void lbtnDel_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < rptList.Items.Count; i++)
            {
                ...
                if (cb.Checked)
                {
                    ...
                    //保存日志
                    SaveLogs("[首页图片管理]增加首页图片内容：" + bll.GetModel(id).Title);
                    //删除记录
                    bll.Delete(id);
                }
            }
