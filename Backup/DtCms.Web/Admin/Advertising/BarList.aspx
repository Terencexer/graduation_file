...
<form id="form1" runat="server">
    <div class="navigation"><span class="add"><a href="BarAdd.aspx?Pid=<%=this.pid %>">增加首页图片</a></span><b>您当前的位置：管理中心 &gt; 系统管理 &gt; 首页图片列表</b></div>
    <div class="spClear"></div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100" align="center"><b>所属首页图片：</b></td>
        <td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      ...
      <tr>
        ...
        <td><a title="查看首页图片" target="_blank" href="<%#Eval("AdUrl") %>"><%#Eval("Title")%></a></td>
        ...
        <div style="line-height:30px;height:30px;">
            ...
            <div class="left">
                ...
                <span class="btn_bg">
                    ...
                    onclick="lbtnDel_Click">删 除</asp:LinkButton>&nbsp;<a href="AdvList.aspx">返回首页图片</a>
                </span>
            </div>
	</div>
</form>
