<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="DtCms.Web.Aspx.register" %>
...
<div class="container">
	...
	<div class="page_left">
		<h2 id="page_title">会员注册</h2>
		<div id="comment">
			<div class="clear"></div>
			<div class="commentform">
				<div class="nTitle">会员注册</div>
				<form id="comment_form" name="comment_form" runat="server">
					...
					<dl>
						<dt>姓名：</dt>
						<dd>
						<asp:TextBox ID="txtTureName" runat="server" maxlength="30" class="input2 required" style="width:250px;" ></asp:TextBox>
						</dd>
					</dl>
					<dl>
						<dt>联系电话：</dt>
						<dd>
						<asp:TextBox ID="txtUserTel" runat="server" maxlength="30" class="input2 required" style="width:250px;" ></asp:TextBox>
						</dd>
					</dl>
					<dl>
						<dt>在线QQ：</dt>
						<dd>
						<asp:TextBox ID="txtUserQQ" runat="server" maxlength="30" class="input2 required" style="width:250px;" ></asp:TextBox>
						</dd>
					</dl>
					<dl>
						<dt>验证码：</dt>
						...
						<dd>
                            <asp:Button id="btnSubmit" name="btnSubmit" runat="server" Text="提交保存" 
