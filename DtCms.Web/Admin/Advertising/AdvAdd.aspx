...
<form id="form1" runat="server">
    <div class="navigation">
      <span class="back"><a href="AdvList.aspx">返回列表</a></span><b>您当前的位置：管理中心 &gt; 系统管理 &gt; 增加首页图片</b>
    </div>
    <div class="spClear"></div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        <th colspan="2" align="left">增加首页图片</th>
      </tr>
      <tr>
        <td width="25%" align="right">首页图片名称：</td>
        <td width="75%">
          <asp:TextBox ID="txtTitle" runat="server" CssClass="input required" size="30" 
            maxlength="50" HintTitle="首页图片名称" HintInfo="请填写首页图片名称，至少1个字符，小于50个字符，如“首页顶部通栏首页图片”。"></asp:TextBox>
        </td>
       </tr>
       <tr>
         <td align="right">首页图片类型：</td>
         <td>
       ...
       <tr>
         ...
         <td>
          <asp:TextBox ID="txtAdRemark" runat="server" CssClass="input" size="50" 
            maxlength="100" HintTitle="首页图片备注说明" HintInfo="请填写首页图片备注说明，至少1个字符，小于100个字符。"></asp:TextBox>
           </td>
       </tr>
       <tr>
         <td align="right">显示首页图片数：</td>
         <td>
          <asp:TextBox ID="txtAdNum" runat="server" CssClass="input required number" size="5" 
            maxlength="10" HintTitle="首页图片要显示的首页图片数量" HintInfo="请填写显示首页图片数量，只能输入正整数，不能小于零。"></asp:TextBox>
           &nbsp;条</td>
       </tr>
       <tr style="display:none;">
         ...
         <td>
          <asp:TextBox ID="txtAdPrice" runat="server" CssClass="input required number" size="5" 
            maxlength="10" HintTitle="首页图片价格" HintInfo="请填写该首页图片的每月价格，单位为元/月。"></asp:TextBox></td>
       </tr>
       <tr>
         <td align="right">宽度：</td>
         <td> 
          <asp:TextBox ID="txtAdWidth" runat="server" CssClass="input required number" size="5" 
            maxlength="10" HintTitle="首页图片的宽度" HintInfo="请填写该首页图片的宽度，只能输入正整数，不能小于零。"></asp:TextBox>
           &nbsp;px</td>
       </tr>
       <tr>
         ...
         <td> 
          <asp:TextBox ID="txtAdHeight" runat="server" CssClass="input required number" size="5" 
            maxlength="10" HintTitle="首页图片的高度" HintInfo="请填写该首页图片的高度，只能输入正整数，不能小于零。"></asp:TextBox>
           &nbsp;px</td>
       </tr>
       <tr>
