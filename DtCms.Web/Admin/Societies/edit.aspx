<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="DtCms.Web.Admin.Societies.edit" %>
...
<body style="padding:10px;">
    ...
    <div class="navigation">
      <span class="back"><a href="list.aspx">返回队伍列表</a></span><b>您当前的位置：首页 &gt; 系统队伍 &gt; 队伍</b>
    </div>
    <div style="padding-bottom:10px;"></div>
    <table width="900px" border="0" cellspacing="0" cellpadding="0" class="msgtable">
              <tr>
                <td width="25%" align="right">队伍名：</td>
                <td width="75%">
